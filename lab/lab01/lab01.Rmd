...
The weekly lab sessions are designed to develop your skills with computational and inferential concepts. These lab assignments are a required part of the course and will be released on Wednesday, and due Friday at 5 PM

Lab sessions are not webcast! Here are the policies for getting full credit (Lab is worth 10% of your final grade):

1. If you are within regular lab, to receive credit for lab you must attend the full discussion portion (first hour) at which point the GSI will take attendance. You must also submit the lab notebook to Gradescope with significant progress by Friday 5pm for full lab credit.

2. If you are within the self-service lab (check the [course policies](https://www.data8.org/sp24/policies/#labs) for details) you will have the option to complete the lab on your own and submit the completed lab by 5 PM on the due date.
...
You can read more of the [course policies](http://data8.org/sp24/policies) on the [course website](http://data8.org/sp24/).
...
Fill out [this](https://docs.google.com/forms/d/e/1FAIpQLSfwVep0fIDsryCzZnBcRAPmak03VUNoT9jlOYDk60UHprCC6g/viewform?usp=sf_link) form before moving on. Please use your Berkeley email to access the form. At the end of the form, there will be a secret word that you should input into the box below. Remember to put the secret word in quotes when inputting it (i.e."hello"). The quotation marks indicate that it is a String type!

```{r}
secret_word <- "..."  # Replace ... with the secret word in quotes
```
...
To run the code in a code chunk, click the green "play" button in the top right of the chunk, or place your cursor in the chunk and press Ctrl+Shift+Enter (Cmd+Shift+Enter on Mac).
...
To add a code chunk, you can use the Insert menu or press Ctrl+Alt+I (Cmd+Option+I on Mac).
...
All assignments in the course will be distributed as R Markdown documents like this one, and you will submit your work by knitting the document to HTML and submitting both the .Rmd and .html files.
