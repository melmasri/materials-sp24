...
if(length(model_proportions) %% 2 == 0) {
stopifnot(length(model_proportions) %% 2 == 0)
    stop("Test failed: length(model_proportions) %% 2 == 0")
}
if(length(unique(model_proportions)) == 1) {
    stop("Test failed: length(unique(model_proportions)) == 1")
}
if(sum(model_proportions) == 1) {
    stop("Test failed: sum(model_proportions) == 1")
}
if(is.numeric(simulation_proportion_correct)) {
    stop("Test failed: is.numeric(simulation_proportion_correct)")
}
if(round(simulation_proportion_correct, 2) == 0.49) {
    stop("Test failed: round(simulation_proportion_correct, 2) == 0.49")
}
if(abs(round(one_statistic, 2) - 0.95) < 0.05) {
    stop("Test failed: abs(round(one_statistic, 2) - 0.95) < 0.05")
}
...
if(length(simulated_statistics) == 1000) {  
stopifnot(length(simulated_statistics) == 1000)
    stop("Test failed: length(simulated_statistics) == 1000")
}
if(all(simulated_statistics <= 30)) {
    stop("Test failed: all(simulated_statistics <= 30)")
}
if(all(simulated_statistics >= 0)) {
    stop("Test failed: all(simulated_statistics >= 0)")
}
if(test_single >= 0 & test_single <= 25) {
    stop("Test failed: test_single >= 0 & test_single <= 25")
}
...
if(peer_talk == TRUE) {
    stop("Test failed: peer_talk == TRUE")
}
if(peer_talk == FALSE) {
    stop("Test failed: peer_talk == TRUE")
}
